 ...
 */
final class Version20230816113118 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER INDEX uniq_8d93d64989d9b62 RENAME TO UNIQ_911533C8989D9B62');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER INDEX uniq_911533c8989d9b62 RENAME TO uniq_8d93d64989d9b62');
        $this->addSql('ALTER TABLE comment ALTER created_at TYPE TIMESTAMP(0) WITHOUT TIME ZONE');
